...
本文件是御方通和“尽快上线版”的需求冻结基线，不是完整 ERP、自动结算或资金系统设计。后续开发必须以本文件和项目主控的确认结果为依据。
...
收益来源是 B 商家补货的实付金额，收益比例暂未确定，必须配置化并保留规则版本，不能写死。
...
- “线上核销”对 `9800` 推荐奖励生效的确切业务事件，以及观察期配置范围。
- 普通商品推荐比例、补货收益比例、冻结/解冻/冲正规则和线下结算凭证标准。
- B 商家倒闭后的合同/客服处置、会员重新购买规则和城市合伙人客户查看授权。
