...
class CreateYfthReferralRewardTables extends Migrator
{
    ...
    private function createRewardLedger(): void
    {
        ...
        $this->table('yfth_reward_ledger')
            ...
            ->addColumn('ledger_unique_key', 'string', ['limit' => 191, 'default' => '', 'comment' => 'immutable business reward uniqueness key'])
            ...
            ->addIndex(['ledger_unique_key'], ['unique' => true, 'name' => 'uniq_yfth_reward_ledger_unique_key'])
