...
try {
    ...
    $assert(strpos($service, 'assignFirstInTransaction') !== false && strpos($service, 'closeForMembershipInTransaction') !== false, 'activation_uses_stage1a_transaction_boundaries');
    ...
    $candidateEnd = strpos($migration, 'private function seedMenus', $candidateStart);
