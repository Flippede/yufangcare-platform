...
$assertContains($activation, 'createPlanAndBenefits', 'Paid package activation must create benefit plan and items');
...
$assertContains($refund, 'quantity_used', 'Refund service must distinguish fulfilled benefits');
