...
$guards = [
    ...
    'acceptance_pass_requires_verified_profile' => 'franchise_acceptance_store_profile_not_verified',
    'formal_store_creation_after_acceptance' => 'franchise_store_create_acceptance_not_passed',
    'formal_store_creation_locks_profile' => "Db::name('yfth_franchise_store_profile')->where('id', \$profileId)->lock(true)->find()",
    'formal_store_creation_idempotent' => "'created' => false",
