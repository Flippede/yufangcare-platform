...
return [
    ...
    'listen' => [
        ...
        'OrderPaySuccessListener' => [\app\listener\order\OrderPaySuccessListener::class, \app\listener\yfth\PackagePaySuccessListener::class, \app\listener\yfth\MallConsumptionRewardPayListener::class, \app\listener\yfth\ProcurementPartnerProfitPayListener::class], //订单支付成功后置事件
        ...
        'OrderRefundCancelAfterListener' => [\app\listener\order\OrderRefundCancelAfterListener::class, \app\listener\yfth\PackageRefundCancelListener::class], //售后单取消后置事件
        ...
        'CustomEventListener' => [\app\listener\yfth\PackageCustomEventListener::class, \app\listener\yfth\MallConsumptionRewardCustomEventListener::class, \app\listener\yfth\ProcurementPartnerProfitCustomEventListener::class, \app\listener\CustomEventListener::class],//自定义事件
    ],
];
